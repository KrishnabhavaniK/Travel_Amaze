...
const packageDetails = {
    premium: {
        ...
        features: [
            ...
            '5-Star Hotel Stay in Leh & Nubra Valley',
            'Private Tour Guide',
            'All Ladakhi Cuisine Meals Included',
            'Priority Access to Pangong Lake & Monasteries'
        ]
    },
    gold: {
        name: 'Gold Package',
        ...
        features: [
            'AC SUV Travel',
            '4-Star Mountain Resort Stay in Leh',
            'Expert Local Guide',
            'Ladakhi Breakfast & Dinner',
            'Standard Access to Tourist Attractions & Monasteries'
        ]
    },
    silver: {
        name: 'Silver Package',
        price: 18000,
        features: [
            'Train & Shared Jeep Travel',
            '3-Star Hotel in Leh',
            'Group Tour Guide',
            'Ladakhi Breakfast Only',
            'Basic Sightseeing of Leh Palace & Shanti Stupa'
        ]
    }
};
...
const flightData = {
    delhi: [
        { id: 1, airline: 'Air India', departure: '06:30', arrival: '09:15', price: 7500, duration: '2h 45m', flightNo: 'AI-203' },
        { id: 2, airline: 'IndiGo', departure: '11:00', arrival: '13:45', price: 7200, duration: '2h 45m', flightNo: '6E-456' }
    ],
    mumbai: [
        { id: 3, airline: 'Vistara', departure: '08:00', arrival: '10:30', price: 7800, duration: '2h 30m', flightNo: 'UK-789' },
        { id: 4, airline: 'SpiceJet', departure: '14:00', arrival: '16:30', price: 7400, duration: '2h 30m', flightNo: 'SG-123' }
    ],
    bangalore: [
        { id: 5, airline: 'IndiGo', departure: '07:15', arrival: '09:45', price: 8000, duration: '2h 30m', flightNo: '6E-901' },
        { id: 6, airline: 'Air India', departure: '12:30', arrival: '15:00', price: 7700, duration: '2h 30m', flightNo: 'AI-456' }
    ],
    chennai: [
        { id: 7, airline: 'SpiceJet', departure: '09:00', arrival: '11:30', price: 8200, duration: '2h 30m', flightNo: 'SG-234' },
        { id: 8, airline: 'Vistara', departure: '16:00', arrival: '18:30', price: 7900, duration: '2h 30m', flightNo: 'UK-567' }
    ],
    kolkata: [
        { id: 9, airline: 'Air India', departure: '05:30', arrival: '08:15', price: 8500, duration: '2h 45m', flightNo: 'AI-789' },
        { id: 10, airline: 'IndiGo', departure: '13:00', arrival: '15:45', price: 8100, duration: '2h 45m', flightNo: '6E-123' }
    ],
    hyderabad: [
        { id: 11, airline: 'Vistara', departure: '06:45', arrival: '09:15', price: 8600, duration: '2h 30m', flightNo: 'UK-321' },
        { id: 12, airline: 'SpiceJet', departure: '15:30', arrival: '18:00', price: 8300, duration: '2h 30m', flightNo: 'SG-876' }
    ],
    kanpur: [
        { id: 13, airline: 'IndiGo', departure: '07:00', arrival: '09:45', price: 7900, duration: '2h 45m', flightNo: '6E-789' },
        { id: 14, airline: 'Air India', departure: '14:00', arrival: '16:45', price: 7500, duration: '2h 45m', flightNo: 'AI-234' }
    ],
    surat: [
        { id: 15, airline: 'SpiceJet', departure: '08:30', arrival: '11:00', price: 8200, duration: '2h 30m', flightNo: 'SG-543' },
        { id: 16, airline: 'Vistara', departure: '17:00', arrival: '19:30', price: 7900, duration: '2h 30m', flightNo: 'UK-678' }
    ],
    indore: [
        { id: 17, airline: 'Air India', departure: '06:00', arrival: '08:45', price: 8000, duration: '2h 45m', flightNo: 'AI-901' },
        { id: 18, airline: 'IndiGo', departure: '13:30', arrival: '16:15', price: 7700, duration: '2h 45m', flightNo: '6E-345' }
    ],
    aurangabad: [
        { id: 19, airline: 'IndiGo', departure: '08:00', arrival: '10:30', price: 8700, duration: '2h 30m', flightNo: '6E-789' },
        { id: 20, airline: 'Air India', departure: '17:00', arrival: '19:30', price: 8300, duration: '2h 30m', flightNo: 'AI-234' }
    ],
    coimbatore: [
        { id: 21, airline: 'Vistara', departure: '06:45', arrival: '09:15', price: 8900, duration: '2h 30m', flightNo: 'UK-234' },
        { id: 22, airline: 'SpiceJet', departure: '14:30', arrival: '17:00', price: 8600, duration: '2h 30m', flightNo: 'SG-345' }
    ],
    madurai: [
        { id: 23, airline: 'Air India', departure: '07:30', arrival: '10:00', price: 8800, duration: '2h 30m', flightNo: 'AI-567' },
        { id: 24, airline: 'IndiGo', departure: '15:00', arrival: '17:30', price: 8400, duration: '2h 30m', flightNo: '6E-678' }
    ],
    visakhapatnam: [
        { id: 25, airline: 'SpiceJet', departure: '08:15', arrival: '10:45', price: 9000, duration: '2h 30m', flightNo: 'SG-901' },
        { id: 26, airline: 'Vistara', departure: '16:00', arrival: '18:30', price: 8700, duration: '2h 30m', flightNo: 'UK-456' }
    ],
    vijayawada: [
        { id: 27, airline: 'IndiGo', departure: '07:00', arrival: '09:30', price: 8900, duration: '2h 30m', flightNo: '6E-789' },
        { id: 28, airline: 'Air India', departure: '14:45', arrival: '17:15', price: 8500, duration: '2h 30m', flightNo: 'AI-678' }
    ],
    vadodara: [
        { id: 29, airline: 'Vistara', departure: '06:30', arrival: '09:00', price: 9200, duration: '2h 30m', flightNo: 'UK-123' },
        { id: 30, airline: 'SpiceJet', departure: '15:15', arrival: '17:45', price: 8800, duration: '2h 30m', flightNo: 'SG-234' }
    ],
    gwalior: [
        { id: 31, airline: 'Air India', departure: '07:45', arrival: '10:15', price: 9100, duration: '2h 30m', flightNo: 'AI-456' },
        { id: 32, airline: 'IndiGo', departure: '16:30', arrival: '19:00', price: 8700, duration: '2h 30m', flightNo: '6E-567' }
    ],
    amritsar: [
        { id: 33, airline: 'SpiceJet', departure: '08:30', arrival: '11:00', price: 9300, duration: '2h 30m', flightNo: 'SG-678' },
        { id: 34, airline: 'Vistara', departure: '17:00', arrival: '19:30', price: 8900, duration: '2h 30m', flightNo: 'UK-789' }
    ],
    ludhiana: [
        { id: 35, airline: 'Air India', departure: '06:15', arrival: '08:45', price: 9400, duration: '2h 30m', flightNo: 'AI-345' },
        { id: 36, airline: 'IndiGo', departure: '14:00', arrival: '16:30', price: 9000, duration: '2h 30m', flightNo: '6E-234' }
    ],
    kochi: [
        { id: 37, airline: 'Vistara', departure: '07:45', arrival: '10:15', price: 9500, duration: '2h 30m', flightNo: 'UK-567' },
        { id: 38, airline: 'SpiceJet', departure: '16:00', arrival: '18:30', price: 9100, duration: '2h 30m', flightNo: 'SG-890' }
    ],
    mysore: [
        { id: 39, airline: 'IndiGo', departure: '08:30', arrival: '11:00', price: 9600, duration: '2h 30m', flightNo: '6E-678' },
        { id: 40, airline: 'Air India', departure: '17:15', arrival: '19:45', price: 9200, duration: '2h 30m', flightNo: 'AI-901' }
    ],
    mangalore: [
        { id: 41, airline: 'Vistara', departure: '06:45', arrival: '09:15', price: 9700, duration: '2h 30m', flightNo: 'UK-432' },
        { id: 42, airline: 'SpiceJet', departure: '14:30', arrival: '17:00', price: 9300, duration: '2h 30m', flightNo: 'SG-123' }
    ],
    ahmedabad: [
        { id: 43, airline: 'IndiGo', departure: '07:00', arrival: '09:30', price: 9800, duration: '2h 30m', flightNo: '6E-345' },
        { id: 44, airline: 'Air India', departure: '15:00', arrival: '17:30', price: 9400, duration: '2h 30m', flightNo: 'AI-678' }
    ],
    pune: [
        { id: 45, airline: 'Vistara', departure: '08:15', arrival: '10:45', price: 9900, duration: '2h 30m', flightNo: 'UK-567' },
        { id: 46, airline: 'SpiceJet', departure: '16:45', arrival: '19:15', price: 9500, duration: '2h 30m', flightNo: 'SG-890' }
    ],
    srinagar: [
        { id: 47, airline: 'IndiGo', departure: '07:30', arrival: '10:00', price: 10000, duration: '2h 30m', flightNo: '6E-901' },
        { id: 48, airline: 'Air India', departure: '15:30', arrival: '18:00', price: 9600, duration: '2h 30m', flightNo: 'AI-432' }
    ],
    coimbatore: [
        { id: 49, airline: 'IndiGo', departure: '07:00', arrival: '09:30', price: 10100, duration: '2h 30m', flightNo: '6E-777' },
        { id: 50, airline: 'Air India', departure: '16:00', arrival: '18:30', price: 9700, duration: '2h 30m', flightNo: 'AI-888' }
    ],
    nagpur: [
        { id: 51, airline: 'Vistara', departure: '08:15', arrival: '10:45', price: 10200, duration: '2h 30m', flightNo: 'UK-999' },
        { id: 52, airline: 'SpiceJet', departure: '17:30', arrival: '20:00', price: 9800, duration: '2h 30m', flightNo: 'SG-111' }
    ],
    varanasi: [
        { id: 53, airline: 'IndiGo', departure: '06:45', arrival: '09:15', price: 10300, duration: '2h 30m', flightNo: '6E-222' },
        { id: 54, airline: 'Air India', departure: '14:15', arrival: '16:45', price: 9900, duration: '2h 30m', flightNo: 'AI-333' }
    ]
};
...
const busData = {
    delhi: [
        { id: 1, operator: 'HRTC', departure: '18:00', arrival: '10:00', price: 2500, duration: '16h', busNo: 'HRTC-101' },
        { id: 2, operator: 'JKSRTC', departure: '20:30', arrival: '12:30', price: 2700, duration: '16h', busNo: 'JKSRTC-102' }
    ],
    mumbai: [
        { id: 3, operator: 'VRL Travels', departure: '19:00', arrival: '11:30', price: 2800, duration: '16h 30m', busNo: 'VRL-103' },
        { id: 4, operator: 'Neeta Travels', departure: '21:00', arrival: '13:00', price: 3000, duration: '16h', busNo: 'NEETA-104' }
    ],
    bangalore: [
        { id: 5, operator: 'KSRTC', departure: '17:30', arrival: '10:00', price: 2900, duration: '16h 30m', busNo: 'KSRTC-105' },
        { id: 6, operator: 'VRL Travels', departure: '22:00', arrival: '12:30', price: 3100, duration: '14h 30m', busNo: 'VRL-106' }
    ],
    chennai: [
        { id: 7, operator: 'Parveen Travels', departure: '18:45', arrival: '11:00', price: 2700, duration: '16h 15m', busNo: 'PRVN-107' },
        { id: 8, operator: 'SRS Travels', departure: '20:15', arrival: '10:30', price: 2900, duration: '14h 15m', busNo: 'SRS-108' }
    ],
    kolkata: [
        { id: 9, operator: 'Royal Cruiser', departure: '16:00', arrival: '09:00', price: 3200, duration: '17h', busNo: 'RC-109' },
        { id: 10, operator: 'GreenLine Travels', departure: '21:30', arrival: '12:30', price: 3100, duration: '15h', busNo: 'GLT-110' }
    ],
    hyderabad: [
        { id: 11, operator: 'Orange Tours', departure: '19:00', arrival: '10:00', price: 2900, duration: '15h', busNo: 'ORNG-111' },
        { id: 12, operator: 'VRL Travels', departure: '21:45', arrival: '12:15', price: 3100, duration: '14h 30m', busNo: 'VRL-112' }
    ],
    kanpur: [
        { id: 13, operator: 'Shatabdi Travels', departure: '17:15', arrival: '08:45', price: 2700, duration: '15h 30m', busNo: 'STB-113' },
        { id: 14, operator: 'UPSRTC', departure: '20:30', arrival: '11:00', price: 2850, duration: '14h 30m', busNo: 'UPS-114' }
    ],
    surat: [
        { id: 15, operator: 'Neeta Travels', departure: '18:30', arrival: '10:30', price: 2750, duration: '16h', busNo: 'NEETA-115' },
        { id: 16, operator: 'VRL Travels', departure: '22:00', arrival: '12:30', price: 2950, duration: '14h 30m', busNo: 'VRL-116' }
    ],
    indore: [
        { id: 17, operator: 'Hans Travels', departure: '19:45', arrival: '10:15', price: 2800, duration: '14h 30m', busNo: 'HANS-117' },
        { id: 18, operator: 'Ashok Travels', departure: '21:15', arrival: '11:45', price: 2900, duration: '14h 30m', busNo: 'ASHOK-118' }
    ],
    aurangabad: [
        { id: 19, operator: 'Sharma Travels', departure: '18:30', arrival: '09:30', price: 2850, duration: '15h', busNo: 'ST-119' },
        { id: 20, operator: 'VRL Travels', departure: '21:00', arrival: '11:30', price: 3050, duration: '14h 30m', busNo: 'VRL-120' }
    ],
    coimbatore: [
        { id: 21, operator: 'Parveen Travels', departure: '17:00', arrival: '08:30', price: 2950, duration: '15h 30m', busNo: 'PRVN-121' },
        { id: 22, operator: 'SRS Travels', departure: '20:45', arrival: '10:15', price: 3100, duration: '14h 30m', busNo: 'SRS-122' }
    ],
    madurai: [
        { id: 23, operator: 'Madurai Express', departure: '19:15', arrival: '09:45', price: 2800, duration: '14h 30m', busNo: 'ME-123' },
        { id: 24, operator: 'VRL Travels', departure: '22:30', arrival: '11:00', price: 3000, duration: '14h 30m', busNo: 'VRL-124' }
    ],
    visakhapatnam: [
        { id: 25, operator: 'Vizag Express', departure: '18:45', arrival: '09:15', price: 2900, duration: '14h 30m', busNo: 'VE-125' },
        { id: 26, operator: 'Orange Tours', departure: '21:15', arrival: '10:45', price: 3100, duration: '14h 30m', busNo: 'ORNG-126' }
    ],
    vijayawada: [
        { id: 27, operator: 'Vijayawada Travels', departure: '19:30', arrival: '10:00', price: 2850, duration: '14h 30m', busNo: 'VT-127' },
        { id: 28, operator: 'VRL Travels', departure: '22:00', arrival: '11:30', price: 3050, duration: '14h 30m', busNo: 'VRL-128' }
    ],
    gwalior: [
        { id: 29, operator: 'Gwalior Express', departure: '18:15', arrival: '08:45', price: 2800, duration: '14h 30m', busNo: 'GE-129' },
        { id: 30, operator: 'UPSRTC', departure: '20:30', arrival: '10:00', price: 2950, duration: '14h 30m', busNo: 'UPS-130' }
    ],
    amritsar: [
        { id: 31, operator: 'Punjab Travels', departure: '19:00', arrival: '09:30', price: 2900, duration: '14h 30m', busNo: 'PT-131' },
        { id: 32, operator: 'VRL Travels', departure: '21:30', arrival: '11:00', price: 3100, duration: '14h 30m', busNo: 'VRL-132' }
    ],
    vadodara: [
        { id: 33, operator: 'GSRTC', departure: '18:00', arrival: '09:30', price: 2750, duration: '15h 30m', busNo: 'GSRTC-133' },
        { id: 34, operator: 'VRL Travels', departure: '21:00', arrival: '11:30', price: 2950, duration: '14h 30m', busNo: 'VRL-134' }
    ],
    ludhiana: [
        { id: 35, operator: 'Punjab Travels', departure: '17:30', arrival: '08:45', price: 2850, duration: '15h 15m', busNo: 'PT-135' },
        { id: 36, operator: 'Indo Canadian', departure: '20:45', arrival: '10:15', price: 3050, duration: '14h 30m', busNo: 'IC-136' }
    ],
    kochi: [
        { id: 37, operator: 'KTC Travels', departure: '18:45', arrival: '09:30', price: 2950, duration: '14h 45m', busNo: 'KTC-137' },
        { id: 38, operator: 'Parveen Travels', departure: '22:00', arrival: '11:30', price: 3100, duration: '13h 30m', busNo: 'PRVN-138' }
    ],
    mysore: [
        { id: 39, operator: 'KSRTC', departure: '19:15', arrival: '08:45', price: 2800, duration: '13h 30m', busNo: 'KSRTC-139' },
        { id: 40, operator: 'VRL Travels', departure: '21:45', arrival: '10:15', price: 3000, duration: '12h 30m', busNo: 'VRL-140' }
    ],
    mangalore: [
        { id: 41, operator: 'SRS Travels', departure: '18:30', arrival: '09:00', price: 2900, duration: '14h 30m', busNo: 'SRS-141' },
        { id: 42, operator: 'VRL Travels', departure: '22:15', arrival: '11:45', price: 3100, duration: '13h 30m', busNo: 'VRL-142' }
    ],
    ahmedabad: [
        { id: 43, operator: 'GSRTC', departure: '17:45', arrival: '08:30', price: 2850, duration: '14h 45m', busNo: 'GSRTC-143' },
        { id: 44, operator: 'Neeta Travels', departure: '21:30', arrival: '10:30', price: 3050, duration: '13h', busNo: 'NEETA-144' }
    ],
    pune: [
        { id: 45, operator: 'Purple Travels', departure: '18:15', arrival: '09:15', price: 2750, duration: '15h', busNo: 'PURP-145' },
        { id: 46, operator: 'VRL Travels', departure: '20:45', arrival: '10:15', price: 2950, duration: '13h 30m', busNo: 'VRL-146' }
    ],
    srinagar: [
        { id: 47, operator: 'JKSRTC', departure: '17:30', arrival: '08:30', price: 3100, duration: '15h', busNo: 'JKSRTC-147' },
        { id: 48, operator: 'Himachal Roadways', departure: '21:00', arrival: '10:00', price: 3250, duration: '13h', busNo: 'HRTC-148' }
    ],
    nagpur: [
        { id: 49, operator: 'Hans Travels', departure: '18:00', arrival: '09:00', price: 2950, duration: '15h', busNo: 'HANS-149' },
        { id: 50, operator: 'SRS Travels', departure: '22:00', arrival: '11:30', price: 3150, duration: '13h 30m', busNo: 'SRS-150' }
    ],
    varanasi: [
        { id: 51, operator: 'UPSRTC', departure: '18:45', arrival: '09:30', price: 3000, duration: '14h 45m', busNo: 'UPSRTC-151' },
        { id: 52, operator: 'Shatabdi Travels', departure: '21:15', arrival: '10:45', price: 3200, duration: '13h 30m', busNo: 'STB-152' }
    ]
};
...
const trainData = {
    delhi: [
        { id: 1, trainName: 'Ladakh Express', departure: '18:00', arrival: '08:00', price: 3200, type: 'AC First Class', trainNo: '12951' },
        { id: 2, trainName: 'Himalayan Queen', departure: '20:30', arrival: '10:00', price: 2800, type: 'Sleeper Class', trainNo: '12779' }
    ],
    mumbai: [
        { id: 3, trainName: 'Mumbai-Ladakh Express', departure: '21:00', arrival: '09:30', price: 3400, type: 'AC 2 Tier', trainNo: '10111' },
        { id: 4, trainName: 'Western Himalayas Express', departure: '07:10', arrival: '18:45', price: 3100, type: 'AC 3 Tier', trainNo: '10103' }
    ],
    kanpur: [
        { id: 5, trainName: 'Ladakh Sampark Kranti', departure: '19:00', arrival: '08:30', price: 3000, type: 'AC 2 Tier', trainNo: '12779' },
        { id: 6, trainName: 'Kanpur-Ladakh Express', departure: '22:00', arrival: '11:30', price: 2700, type: 'Sleeper Class', trainNo: '12780' }
    ],
    surat: [
        { id: 7, trainName: 'Surat-Ladakh Express', departure: '20:15', arrival: '09:45', price: 3300, type: 'AC First Class', trainNo: '22911' },
        { id: 8, trainName: 'Northern Heights Express', departure: '23:30', arrival: '12:15', price: 3000, type: 'AC 3 Tier', trainNo: '10111' }
    ],
    indore: [
        { id: 9, trainName: 'Indore-Ladakh Superfast', departure: '18:45', arrival: '08:15', price: 3500, type: 'AC First Class', trainNo: '22909' },
        { id: 10, trainName: 'Indore Express', departure: '21:45', arrival: '10:30', price: 3200, type: 'Sleeper Class', trainNo: '22910' }
    ],
    aurangabad: [
        { id: 11, trainName: 'Aurangabad-Ladakh Express', departure: '19:10', arrival: '09:40', price: 3100, type: 'AC 2 Tier', trainNo: '12745' },
        { id: 12, trainName: 'Deccan Himalayas', departure: '22:30', arrival: '11:50', price: 2900, type: 'Sleeper Class', trainNo: '12746' }
    ],
    coimbatore: [
        { id: 13, trainName: 'Coimbatore-Ladakh Express', departure: '18:20', arrival: '07:50', price: 3700, type: 'AC First Class', trainNo: '12685' },
        { id: 14, trainName: 'Nilgiri Heights', departure: '21:10', arrival: '09:30', price: 3400, type: 'AC 3 Tier', trainNo: '12686' }
    ],
    madurai: [
        { id: 15, trainName: 'Madurai-Ladakh Express', departure: '19:30', arrival: '08:45', price: 3600, type: 'AC First Class', trainNo: '12687' },
        { id: 16, trainName: 'Madurai Superfast', departure: '22:00', arrival: '11:15', price: 3300, type: 'AC 3 Tier', trainNo: '12688' }
    ],
    visakhapatnam: [
        { id: 17, trainName: 'Vizag-Ladakh Express', departure: '17:50', arrival: '07:30', price: 3500, type: 'AC 2 Tier', trainNo: '12841' },
        { id: 18, trainName: 'Vizag Superfast', departure: '20:30', arrival: '10:00', price: 3200, type: 'Sleeper Class', trainNo: '12842' }
    ],
    vijayawada: [
        { id: 19, trainName: 'Vijayawada-Ladakh Express', departure: '18:40', arrival: '07:00', price: 3400, type: 'AC First Class', trainNo: '12741' },
        { id: 20, trainName: 'Krishna Heights', departure: '21:15', arrival: '09:45', price: 3100, type: 'AC 3 Tier', trainNo: '12742' }
    ],
    vadodara: [
        { id: 21, trainName: 'Vadodara-Ladakh Express', departure: '19:20', arrival: '08:30', price: 3500, type: 'AC First Class', trainNo: '12851' },
        { id: 22, trainName: 'Western Heights Express', departure: '22:10', arrival: '10:45', price: 3200, type: 'AC 3 Tier', trainNo: '12852' }
    ],
    gwalior: [
        { id: 23, trainName: 'Gwalior-Ladakh Express', departure: '20:10', arrival: '09:30', price: 3400, type: 'AC First Class', trainNo: '12901' },
        { id: 24, trainName: 'Chambal Express', departure: '23:00', arrival: '11:15', price: 3100, type: 'AC 3 Tier', trainNo: '12902' }
    ],
    amritsar: [
        { id: 25, trainName: 'Golden Temple Express', departure: '18:30', arrival: '07:50', price: 3600, type: 'AC 2 Tier', trainNo: '12921' },
        { id: 26, trainName: 'Punjab-Ladakh Express', departure: '21:00', arrival: '09:15', price: 3300, type: 'Sleeper Class', trainNo: '12922' }
    ],
    ludhiana: [
        { id: 27, trainName: 'Ludhiana-Ladakh Express', departure: '19:40', arrival: '08:55', price: 3400, type: 'AC First Class', trainNo: '12931' },
        { id: 28, trainName: 'Himalayan Superfast', departure: '22:20', arrival: '10:35', price: 3100, type: 'AC 3 Tier', trainNo: '12932' }
    ],
bangalore: [
        { id: 1, trainName: 'Ladakh Express', departure: '06:00', arrival: '14:30', price: 3200, duration: '32h 30m', trainNo: 'LE-101' },
        { id: 2, trainName: 'Himalayan Superfast', departure: '18:00', arrival: '02:30', price: 3500, duration: '32h 30m', trainNo: 'HSF-102' }
    ],
    chennai: [
        { id: 3, trainName: 'Ladakh Mail', departure: '07:30', arrival: '16:00', price: 3100, duration: '34h 30m', trainNo: 'LM-103' },
        { id: 4, trainName: 'Northern Express', departure: '19:00', arrival: '05:30', price: 3400, duration: '34h 30m', trainNo: 'NE-104' }
    ],
    kolkata: [
        { id: 5, trainName: 'Eastern Himalaya Express', departure: '08:45', arrival: '18:15', price: 3000, duration: '35h 30m', trainNo: 'EHE-105' },
        { id: 6, trainName: 'Ladakh Rajdhani', departure: '20:15', arrival: '06:45', price: 3600, duration: '34h 30m', trainNo: 'LR-106' }
    ],
    hyderabad: [
        { id: 7, trainName: 'Hyderabad Ladakh Express', departure: '09:00', arrival: '19:30', price: 3200, duration: '34h 30m', trainNo: 'HLE-107' },
        { id: 8, trainName: 'Telangana Superfast', departure: '21:00', arrival: '07:30', price: 3500, duration: '34h 30m', trainNo: 'TS-108' }
    ],kochi: [
        { id: 17, trainName: 'Kerala-Ladakh Express', departure: '05:45', arrival: '18:30', price: 3500, duration: '36h 45m', trainNo: 'KLE-117' },
        { id: 18, trainName: 'Southern Himalaya Express', departure: '19:00', arrival: '07:45', price: 3800, duration: '36h 45m', trainNo: 'SHE-118' }
    ],
    mysore: [
        { id: 19, trainName: 'Mysore-Ladakh Express', departure: '06:15', arrival: '20:00', price: 3400, duration: '37h 45m', trainNo: 'MLE-119' },
        { id: 20, trainName: 'Karnataka Superfast', departure: '20:30', arrival: '10:15', price: 3700, duration: '37h 45m', trainNo: 'KSF-120' }
    ],
    mangalore: [
        { id: 21, trainName: 'Mangalore Himalayan Express', departure: '07:00', arrival: '21:45', price: 3300, duration: '38h 45m', trainNo: 'MHE-121' },
        { id: 22, trainName: 'Coastal Ladakh Express', departure: '21:15', arrival: '11:00', price: 3600, duration: '38h 45m', trainNo: 'CLE-122' }
    ],
    ahmedabad: [
        { id: 23, trainName: 'Ahmedabad-Ladakh Mail', departure: '08:30', arrival: '22:15', price: 3200, duration: '37h 45m', trainNo: 'ALM-123' },
        { id: 24, trainName: 'Gujarat Himalayan Express', departure: '22:45', arrival: '12:30', price: 3500, duration: '37h 45m', trainNo: 'GHE-124' }
    ],
    pune: [
        { id: 25, trainName: 'Pune-Ladakh Superfast', departure: '09:00', arrival: '23:45', price: 3100, duration: '38h 45m', trainNo: 'PLS-125' },
        { id: 26, trainName: 'Western Himalaya Express', departure: '23:15', arrival: '13:00', price: 3400, duration: '38h 45m', trainNo: 'WHE-126' }
    ],
    srinagar: [
        { id: 27, trainName: 'Srinagar-Ladakh Express', departure: '10:15', arrival: '00:00', price: 2900, duration: '37h 45m', trainNo: 'SLE-127' },
        { id: 28, trainName: 'Jammu-Kashmir Superfast', departure: '00:30', arrival: '14:15', price: 3200, duration: '37h 45m', trainNo: 'JKS-128' }
    ],
    nagpur: [
        { id: 29, trainName: 'Nagpur Himalayan Express', departure: '11:30', arrival: '01:15', price: 3000, duration: '37h 45m', trainNo: 'NHE-129' },
        { id: 30, trainName: 'Maharashtra-Ladakh Mail', departure: '01:45', arrival: '15:30', price: 3300, duration: '37h 45m', trainNo: 'MLM-130' }
    ],
    varanasi: [
        { id: 31, trainName: 'Varanasi-Ladakh Mail', departure: '12:45', arrival: '02:30', price: 3100, duration: '37h 45m', trainNo: 'VLM-131' },
        { id: 32, trainName: 'Ganges Himalaya Express', departure: '02:45', arrival: '16:30', price: 3400, duration: '37h 45m', trainNo: 'GHE-132' }
    ]
};

let currentPackageType = null;
const destination = 'Ladakh';
    ...
    <div class="summary-item transport-info transport-info-${flightType}">
        ...
        <div class="transport-details">
            ${type === 'premium' ? `
                ...
                <span>From: ${flightType === 'outbound' ? fromCity : 'Ladakh'}</span>
                <span>To: ${flightType === 'outbound' ? 'Ladakh' : fromCity}</span>
...
// Hotel data for different packages in Ladakh
const hotelData = {
    premium: [
        {
            ...
            rating: 5,
            price: 35000,
            features: ["Luxury Rooms", "Heated Floors", "Fine Dining", "Mountain View"],
            distance: "Leh City Center",
            image: "../static/images/hotels/grand-dragon.jpg"
        },
        {
            name: "The Indus Valley",
            rating: 5,
            price: 30000,
            features: ["Spacious Rooms", "Multi-Cuisine Restaurant", "Modern Amenities", "Mountain Facing Balconies"],
            distance: "Leh City",
            image: "../static/images/hotels/indus-valley.jpg"
        },
        {
            name: "Ladakh Sarai Resort",
            rating: 5,
            price: 28000,
            features: ["Boutique Cottages", "Eco-Friendly Stay", "Yoga & Meditation", "Outdoor Bonfire"],
            distance: "Saboo Village (Near Leh)",
            image: "../static/images/hotels/ladakh-sarai.jpg"
        }
    ],
    gold: [
        {
            name: "Hotel Zen Ladakh",
            rating: 4,
            price: 18000,
            features: ["Luxury Stay", "Indoor Heated Pool", "Multi-Cuisine Restaurant", "Spa & Wellness"],
            distance: "Leh",
            image: "../static/images/hotels/hotel-zen.jpg"
        },
        {
            name: "The Abduz",
            rating: 4,
            price: 16000,
            features: ["Modern Boutique Hotel", "Comfortable Rooms", "Restaurant & Bar", "Great Location"],
            distance: "Leh",
            image: "../static/images/hotels/the-abduz.jpg"
        },
        {
            name: "Hotel Singge Palace",
            rating: 4,
            price: 14000,
            features: ["Traditional Ladakhi Decor", "Spacious Rooms", "Central Location", "Restaurant & Café"],
            distance: "Leh",
            image: "../static/images/hotels/singge-palace.jpg"
        }
    ],
    silver: [
        {
            ...
            rating: 3,
            price: 9000,
            features: ["Cozy Rooms", "Traditional Ladakhi Architecture", "Mountain Views", "Budget-Friendly"],
            distance: "Leh",
            image: "../static/images/hotels/reenam-hotel.jpg"
        },
        {
            name: "Hotel Ladakh Greens",
            rating: 3,
            price: 8500,
            features: ["Garden Views", "Comfortable Stay", "Restaurant", "Quiet Location"],
            distance: "Leh",
            image: "../static/images/hotels/ladakh-greens.jpg"
        },
        {
            name: "Sangto Villa Resort",
            rating: 3,
            price: 8000,
            features: ["Scenic Views", "Spacious Rooms", "Organic Dining", "Peaceful Atmosphere"],
            distance: "Leh",
            image: "../static/images/hotels/sangto-villa.jpg"
        }
    ]
};
...
function generateFlightResults(flights, type) {
    ...
    return flights.map(flight => {
        ...
        const fromLocation = type === 'outbound' ? fromCity : 'Ladakh';
        const toLocation = type === 'outbound' ? 'Ladakh' : fromCity;
