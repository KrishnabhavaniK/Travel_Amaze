...
const packageDetails = {
    premium: {
        ...
        features: [
            ...
            '5-Star Hotel Accommodation in Munnar & Alleppey',
            'Private Tour Guide',
            'All Kerala Cuisine Meals Included',
            'Priority Access to Backwater Cruises & Cultural Shows'
        ]
    },
    gold: {
        name: 'Gold Package',
        ...
        features: [
            'AC Bus Travel',
            '4-Star Resort Stay in Kumarakom',
            'Expert Local Guide',
            'Kerala Breakfast & Dinner',
    ...
    silver: {
        ...
        features: [
            ...
            '3-Star Hotel in Kochi',
            'Group Tour Guide',
            'Kerala Breakfast Only',
    ...
    <div class="summary-item transport-info transport-info-${flightType}">
        ...
        <div class="transport-details">
            ${type === 'premium' ? `
                ...
                <span>From: ${flightType === 'outbound' ? fromCity : 'Kerala'}</span>
                <span>To: ${flightType === 'outbound' ? 'Kerala' : fromCity}</span>
    ...
    premium: [
        {
            ...
            rating: 5,
            price: 40000,
            features: ["Lake View Villa", "Private Pool", "Ayurvedic Spa", "Luxury Houseboat Experience"],
            distance: "On Vembanad Lake",
            image: "../static/images/hotels/kumarakom-resort.jpg"
        },
        {
            name: "Taj Malabar Resort & Spa",
            rating: 5,
            price: 35000,
            features: ["Sea View Room", "Infinity Pool", "Traditional Spa", "Fine Dining"],
            distance: "Waterfront Property",
            image: "../static/images/hotels/taj-malabar.jpg"
        },
        {
            name: "The Zuri Kumarakom",
            rating: 5,
            price: 32000,
            features: ["Lagoon View Room", "Maya Spa", "Private Balcony", "Luxury Amenities"],
            distance: "Lake Shore Location",
            image: "../static/images/hotels/zuri-kumarakom.jpg"
        }
    ],
    gold: [
        {
            ...
            rating: 4,
            price: 15000,
            features: ["Heritage Villa", "Backwater Views", "Ayurvedic Center", "Pool"],
            distance: "Backwater Property",
            image: "../static/images/hotels/coconut-lagoon.jpg"
        },
        {
            name: "Punnamada Resort",
            rating: 4,
            price: 12000,
            features: ["Lake View Room", "Swimming Pool", "Spa Services", "Restaurant"],
            distance: "Lake Front",
            image: "../static/images/hotels/punnamada.jpg"
        },
        {
            name: "Lakesong Resort",
            rating: 4,
            price: 10000,
            features: ["Garden View Room", "Pool Access", "Spa", "Water Activities"],
            distance: "Backwater Setting",
            image: "../static/images/hotels/lakesong.jpg"
        }
    ],
    silver: [
        {
            ...
            distance: "Near Backwaters",
            image: "../static/images/hotels/eastend.jpg"
        },
        {
            name: "Backwater Ripples",
            rating: 3,
            price: 6000,
            features: ["Classic Room", "Restaurant", "Garden View", "Wi-Fi"],
            distance: "Backwater Access",
            image: "../static/images/hotels/backwater-ripples.jpg"
        },
        {
            name: "Palm Grove Lake Resort",
            rating: 3,
            price: 5000,
            features: ["Standard Room", "Basic Amenities", "Restaurant", "Garden"],
            distance: "Lake View",
            image: "../static/images/hotels/palm-grove.jpg"
        }
    ]
};
...
function generateFlightResults(flights, type) {
    ...
    return flights.map(flight => {
        ...
        const fromLocation = type === 'outbound' ? fromCity : 'Kerala';
        const toLocation = type === 'outbound' ? 'Kerala' : fromCity;
